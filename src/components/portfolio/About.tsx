        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-xl font-semibold mb-4 text-primary">Career Goals</h3>
          ...
          >
            <Card className="card-gradient border-0 p-8">
              <CardContent className="p-0">
                <h3 className="text-xl font-semibold mb-6 text-primary">Core Interests</h3>
            ...
            <Card className="card-gradient border-0 p-8">
              <CardContent className="p-0">
                <h3 className="text-xl font-semibold mb-6 text-primary">Development Philosophy</h3>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-accent mt-2.5"></div>
